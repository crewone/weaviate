...
func (i *Index) replicationEnabled() bool {
	...
	// fmt.Println(time.Now().Format("15:04:05.000"), "NATEE replicationEnabled", i.Config.ReplicationFactor)
...
func (i *Index) putObjectBatch(ctx context.Context, objects []*storobj.Object,
	...
	fmt.Println(time.Now().Format("15:04:05.000"), "NATEE putObjectBatch check if replication is enabled", i.replicationEnabled(), replProps, i.Config.ReplicationFactor)
	...
	for shardName, group := range byShard {
		...
		f := func() {
			...
			var errs []error
			if replProps != nil {
				fmt.Println(time.Now().Format("15:04:05.000"), "NATEE putObjectBatch replprops NOT nil", shardName)
				...
				if err != nil {
					...
					fmt.Println(time.Now().Format("15:04:05.000"), "NATEE putObjectBatch replprops is nil and shard is NOT nil", shardName)
					...
					fmt.Println(time.Now().Format("15:04:05.000"), "NATEE putObjectBatch replprops is nil and shard is nil", shardName)
